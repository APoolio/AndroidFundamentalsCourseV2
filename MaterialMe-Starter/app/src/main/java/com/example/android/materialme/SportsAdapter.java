...
class SportsAdapter extends RecyclerView.Adapter<SportsAdapter.ViewHolder>
{
    ...
    class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener
    {
        ...
        public void onClick(View view)
        {
            ...
            Intent detaiLntent = new Intent(mContext, DetailActivity.class);
            detaiLntent.putExtra("title", currentSport.getTitle());
            detaiLntent.putExtra("image_resource", currentSport.getImageResource());
            mContext.startActivity(detaiLntent);
        }
    }
}
