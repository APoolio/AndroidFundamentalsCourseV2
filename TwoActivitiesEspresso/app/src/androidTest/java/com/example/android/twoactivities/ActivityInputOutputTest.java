...
public class ActivityInputOutputTest
{
    ...
    {
        onView(withId(R.id.button_main)).perform((click())); //finds the view "button_main" and then performs a click on it
        onView(withId(R.id.text_header)).check(matches(isDisplayed())); //finds the view "text_header" and checks if it is displayed
        onView(withId(R.id.button_second)).perform(click()); //same as above but reversed
        onView(withId(R.id.text_header_reply)).check(matches(isDisplayed())); //same as above but reversed
    }
