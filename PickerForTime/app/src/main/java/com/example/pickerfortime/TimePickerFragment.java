...
public class TimePickerFragment extends DialogFragment implements TimePickerDialog.OnTimeSetListener
{
    ...
    /* Starts with the current time as preselected */
    @Override
    ...
    /* User has picked a time and is calling processTimePickerResult in the MainActivity to display to the user the time they have selected */
    @Override
    public void onTimeSet(android.widget.TimePicker timePicker, int hourOfDay, int minute)
    {
        /* Getting an instance of the MainActivity class */
